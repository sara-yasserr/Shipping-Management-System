        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CancelledOrderPercentage = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                    CityId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryAgent_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_DeliveryAgent_Branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SpecificRole = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fast = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                    Express = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "Admin-ROLE-001", null, "Admin", "ADMIN" },
                    { "DeliveryAgent-ROLE-001", null, "DeliveryAgent", "DELIVERYAGENT" },
                    { "Employee-ROLE-001", null, "Employee", "EMPLOYEE" },
                    { "Seller-ROLE-001", null, "Seller", "SELLER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAgent_BranchId",
                table: "DeliveryAgent",
                column: "BranchId");
